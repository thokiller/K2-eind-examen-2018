            ...
            <form class="form" method="POST" action="{{ url('/register') }}">
                ...
                <div class="bs-row formfield">
                    <div class="bs-col-3">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="initial" name="initial" value="{{old('initial')}}"/>
                    ...
                    <div class="bs-col-2">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="insertion" name="insertion" value="{{old('insertion')}}"/>
                    ...
                    <div class="bs-col-4">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="lastname" name="lastname" value="{{old('lastname')}}"/>
                ...
                <div class="bs-row formfield">
                    <div class="bs-col-6">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="address" name="address" value="{{old('address')}}"/>
                ...
                <div class="bs-row formfield">
                    <div class="bs-col-4">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="town" name="town" value="{{old('town')}}"/>
                        @if ($errors->has('town'))
                            <div class="help-block" style="display: block;">
                                {{ $errors->first('town') }}
                            </div>
                    ...
                    <div class="bs-col-2">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="postal_code" name="postal_code" value="{{old('postal_code')}}"/>
                ...
                <div class="bs-row formfield">
                    <div class="bs-col-4">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="phone" name="phone" value="{{old('phone')}}"/>
                        @if ($errors->has('phone'))
                            <div class="help-block" style="display: block;">
                                {{ $errors->first('phone') }}
                            </div>
                    ...
                    <div class="bs-col-4">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="mobile" name="mobile" value="{{old('mobile')}}"/>
                ...
                <div class="bs-row formfield">
                    <div class="bs-col-4">
                        ...
                        <input type="text" class="textInput inputSpacer__input textInput--fullWidth" id="license_number" name="license_number" value="{{old('license_number')}}"/>
                ...
                <div class="bs-row formfield">
                    <div class="bs-col-4" data-controller="generic/ui/DatePicker">
                        ...
                        <input type="text" class="textInput textInput--fullWidth datePicker__input is-pristine" id="license_issued" name="license_issued" placeholder="mm-dd-jjjj" value="{{old('license_issued')}}">
                    ...
                    <div class="bs-col-4" data-controller="generic/ui/DatePicker">
                        ...
                        <input type="text" class="textInput textInput--fullWidth datePicker__input is-pristine" id="license_valid_till" name="license_valid_till" placeholder="mm-dd-jjjj" value="{{old('license_valid_till')}}">
                        <a href="#" class="datePicker__button icon icon--calendar--nsBlue picker__input" id="P927820657" type="text" aria-haspopup="true" aria-expanded="false" aria-readonly="false" aria-owns="P927820657_root">
                            <span class="alt">Kalender openen</span>
                        </a>
                    ...
                    <div class="bs-col-8">
                        ...
                        <div class="bs-form-check bs-form-check-inline">
                            <input class="checkbox__input" type="checkbox" id="RijbewijsCheckbox1" value="B" name="license_category[]"
                                   @if(is_array(old('license_category')) && in_array('B', old('license_category'))) checked @endif>
                        ...
                        <div class="bs-form-check bs-form-check-inline">
                            <input class="checkbox__input" type="checkbox" id="RijbewijsCheckbox2" value="BE" name="license_category[]"
                                   @if(is_array(old('license_category')) && in_array('BE', old('license_category'))) checked @endif>
                        ...
                        <div class="bs-form-check bs-form-check-inline">
                            <input class="checkbox__input" type="checkbox" id="RijbewijsCheckbox3" value="C" name="license_category[]"
                                   @if(is_array(old('license_category')) && in_array('C', old('license_category'))) checked @endif>
                        ...
                        <div class="bs-form-check bs-form-check-inline">
                            <input class="checkbox__input" type="checkbox" id="RijbewijsCheckbox4" value="CE" name="license_category[]"
                                   @if(is_array(old('license_category')) && in_array('CE', old('license_category'))) checked @endif>
                        ...
                        <div class="bs-form-check bs-form-check-inline">
                            <input class="checkbox__input" type="checkbox" id="RijbewijsCheckbox5" value="D" name="license_category[]"
                                   @if(is_array(old('license_category')) && in_array('D', old('license_category'))) checked @endif>
                        ...
                        <div class="bs-form-check bs-form-check-inline">
                            <input class="checkbox__input" type="checkbox" id="RijbewijsCheckbox6" value="DE" name="license_category[]"
                                   @if(is_array(old('license_category')) && in_array('DE', old('license_category'))) checked @endif>
                ...
                <div class="bs-row formfield">
                    <div class="bs-col-4">
                        ...
                        <input type="text" class="textInput textInput--fullWidth" id="customer_username" name="customer_username" value="{{old('customer_username')}}"/>
                ...
                <div class="bs-row formfield">
                    <div class="bs-col-4">
                        ...
                        <input type="email" class="textInput textInput--fullWidth" id="customer_email" name="customer_email" value="{{old('customer_email')}}"/>
